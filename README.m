...
原文中提供的 Demo 基于 Xcode 7.3、iOS 9.3 和 Swift 2.2，老司机在实践中已对 Demo 进行更新，支持 Swift 4.2。值得注意的是applicationFinishedRestoringState 是在 viewWillAppear之后执行，很多资料对此描述有误。
