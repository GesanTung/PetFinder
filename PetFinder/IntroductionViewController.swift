...
class IntroductionViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    let pan = UIPanGestureRecognizer.init(target: self, action: #selector(self.didPan(pan:)))
  ...
  override func viewDidLayoutSubviews() {
    ...
    @IBAction func rejectBtnWasTapped(_ sender: Any) {
        animateProfileViewLeft()
    }

    @IBAction func acceptBtnWasTapped(_ sender: Any) {
